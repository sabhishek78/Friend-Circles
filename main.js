...
// ith and jth students are `direct` friends with each other, otherwise not. And you have to output the total number of friend 
...
console.log(friendCircleNum([[1,1,0],
    [1,1,0],
    [0,0,1]]));
console.log(friendCircleNum([[1,1,0],
    [1,1,1],
    [0,1,1]]));
console.log(friendCircleNum([[1,0,0],
    [0,1,0],
    [0,0,1]]));